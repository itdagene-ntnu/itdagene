...
urlpatterns = [
    ...
    re_path(r'^companies/(?P<id>\d+)/book/$', book_company, name='itdagene.company.book_company'),
    re_path(
        r'^companies/(?P<id>\d+)/waiting_list', waiting_list, name='itdagene.company.waiting_list'
    ),
    re_path(r'^companies/(?P<id>\d+)/set-status$', set_status, name='itdagene.company.set_status'),
    re_path(
    ...
    re_path(r'^packages/(?P<id>\d+)/$', packages.view, name='itdagene.company.packages.view'),
    re_path(r'^packages/(?P<id>\d+)/edit$', packages.edit, name='itdagene.company.packages.edit'),
    re_path(
        r'^economics/$',
