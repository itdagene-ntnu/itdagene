    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(max_length=20, verbose_name='type', choices=[(b'si', 'Summer internship'), (b'pp', 'Permanent position'), (b'bi', 'Bad import')])),
                ('description', models.TextField()),
                ('image', models.ImageField(upload_to=b'joblistings/', null=True, verbose_name='image', blank=True)),
