    ...
    operations = [migrations.CreateModel(
        ...
        fields=[('id', models.AutoField(verbose_name='ID',
                ...
                ('internship_marathon_rating', models.IntegerField(
                    ...
                    choices=[(0, 'Did not use'), (1, '1: Very bad'),
                             (2, '2: Bad'), (3, '3: Not bad or good'),
                ...
                ('has_interview_location', models.BooleanField(
                    default=False,
                    verbose_name='Did you use interview rooms?')),
                ...
                ('interview_location_improvement', models.TextField(
                    verbose_name='What could have been done better?',
                    blank=True)),
                ('has_banquet', models.BooleanField(
                    default=False,
                    verbose_name='Where you at the banquet?')),
                  ...
                  migrations.CreateModel(
                      ...
                      [('id', models.AutoField(verbose_name='ID',
                       ...
                       ('type', models.PositiveIntegerField(default=1,
                                                            verbose_name='type',
                                                            choices=[(0, 'Bug'
                                     ), (1, 'Feature'), (2, 'Cache problem')])),
                       ('status', models.PositiveIntegerField(
                           default=0,
                           verbose_name='status',
                           choices=[(0, 'New'), (1, 'In progress'),
                                    (2, 'Needs feedback'), (3, 'Finished')])),
                       ('description', models.TextField(verbose_name=
                                                        'description')),
                       ('is_solved',
                        models.BooleanField(default=False,
                                            verbose_name='is solved')),
                       ...
                       ('solved_date',
                        models.DateTimeField(null=True,
                                             ...
                                             blank=True)),
                       ('assigned_user',
                        models.ForeignKey(related_name=b'assigned_issues',
                                          verbose_name='assigned user',
                                          blank=True,
                                          to=settings.AUTH_USER_MODEL,
                                          null=True)),
                       ('creator',
                        models.ForeignKey(related_name=b'issue_creator',
                                          editable=False,
                                          to=settings.AUTH_USER_MODEL)),
                       ('saved_by',
                        models.ForeignKey(related_name=b'issue_saved_by',
                                          editable=False,
                                          to=settings.AUTH_USER_MODEL)), ],
                      options={
                          'verbose_name': 'issue',
