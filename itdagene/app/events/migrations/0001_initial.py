...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_event', (
            ...
            ('saved_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_saved_by', to=orm['auth.User'])),
        ...
        # Adding model 'Ticket'
        db.create_table('events_ticket', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ticket_creator', to=orm['auth.User'])),
            ('saved_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ticket_saved_by', to=orm['auth.User'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')()),
            ('date_saved', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        db.send_create_signal('events', ['Ticket'])
    ...
    models = {
        ...
        'events.event': {
            ...
            'saved_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'event_saved_by'", 'to': "orm['auth.User']"}),
        ...
        'events.ticket': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'saved_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ticket_saved_by'", 'to': "orm['auth.User']"}),
