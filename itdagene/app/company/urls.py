...
urlpatterns = [
    ...
    url(r'^contacts/(?P<company>\d+)/add/$', company_contacts.add_contact),
    ...
    url(r'^contracts/(?P<company_id>\d+)/add/$', contracts.add_contract),
    url(r'^contracts/(?P<company_id>\d+)/edit/(?P<id>\d+)/$', contracts.edit_contract),
    url(r'^contracts/(?P<company_id>\d+)/download/(?P<id>\d+)/$', contracts.download_contract),
