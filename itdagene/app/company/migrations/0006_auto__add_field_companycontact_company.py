...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CompanyContact.company'
        db.add_column('company_companycontact', 'company', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='company_contacts', to=orm['company.Company']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CompanyContact.company'
        db.delete_column('company_companycontact', 'company_id')
