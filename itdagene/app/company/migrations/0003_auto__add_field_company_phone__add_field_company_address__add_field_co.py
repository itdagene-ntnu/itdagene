...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('company_company', 'phone', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Company.address'
        db.add_column('company_company', 'address', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Company.payment_address'
        db.add_column('company_company', 'payment_address', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Company.phone'
        db.delete_column('company_company', 'phone')

        # Deleting field 'Company.address'
        db.delete_column('company_company', 'address')

        # Deleting field 'Company.payment_address'
        db.delete_column('company_company', 'payment_address')
