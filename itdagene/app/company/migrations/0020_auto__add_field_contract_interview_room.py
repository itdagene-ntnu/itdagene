...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contract.interview_room'
        db.add_column('company_contract', 'interview_room', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contract.interview_room'
        db.delete_column('company_contract', 'interview_room')
