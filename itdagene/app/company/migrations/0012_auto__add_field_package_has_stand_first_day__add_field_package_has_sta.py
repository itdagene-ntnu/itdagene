...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Package.has_stand_first_day'
        db.add_column('company_package', 'has_stand_first_day', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Package.has_stand_last_day'
        db.add_column('company_package', 'has_stand_last_day', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Package.has_stand_first_day'
        db.delete_column('company_package', 'has_stand_first_day')

        # Deleting field 'Package.has_stand_last_day'
        db.delete_column('company_package', 'has_stand_last_day')
    ...
    models = {
        ...
        'company.company': {
            ...
            'package': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'companies'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['company.Package']"}),
