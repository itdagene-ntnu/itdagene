...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.uses_tickets'
        db.add_column('events_event', 'uses_tickets', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.uses_tickets'
        db.delete_column('events_event', 'uses_tickets')
    ...
    models = {
        ...
        'events.event': {
            ...
            'uses_tickets': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'events.ticket': {
