...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompanyContact.phone'
        db.alter_column('company_companycontact', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'CompanyContact.mobile_phone'
        db.alter_column('company_companycontact', 'mobile_phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))


    def backwards(self, orm):
        
        # Changing field 'CompanyContact.phone'
        db.alter_column('company_companycontact', 'phone', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'CompanyContact.mobile_phone'
        db.alter_column('company_companycontact', 'mobile_phone', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
