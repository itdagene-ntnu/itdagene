...
urlpatterns = [
    ...
    url(r'^report/(?P<year>\d{4})/$', evalutions.report,
    ...
    url(r'^issues/solved/$', issues.solved_list, name='itdagene.app.feedback.views.issues.solved_list'),
    ...
    url(r'^issues/(?P<id>\d+)/solved$', issues.solved, name='itdagene.app.feedback.views.issues.solved'),
]
