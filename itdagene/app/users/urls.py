...
from itdagene.app.users.views import user_list, user_create, user_detail, send_welcome_email, \
    user_edit, user_edit_password, user_delete
...
urlpatterns = [
    ...
    url(r'^(?P<pk>\d+)/welcome_email/$', send_welcome_email, name='itdagene.app.users.views.send_welcome_email'),
    ...
    url(r'^(?P<pk>\d+)/edit/password/$', user_edit_password,
