...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('company_callteam_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('callteam', models.ForeignKey(orm['company.callteam'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('company_callteam_users', ['callteam_id', 'user_id'])

        # Adding field 'Company.logo'
        db.add_column('company_company', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('company_callteam_users')

        # Deleting field 'Company.logo'
        db.delete_column('company_company', 'logo')
