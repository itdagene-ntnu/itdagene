...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CompanyContact.mobile_phone'
        db.add_column('company_companycontact', 'mobile_phone', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Company.active'
        db.add_column('company_company', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CompanyContact.mobile_phone'
        db.delete_column('company_companycontact', 'mobile_phone')

        # Deleting field 'Company.active'
        db.delete_column('company_company', 'active')
    ...
    models = {
        ...
        'company.companycontact': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'mobile_phone': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
