...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contract.is_billed'
        db.add_column('company_contract', 'is_billed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Contract.has_paid'
        db.add_column('company_contract', 'has_paid', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contract.is_billed'
        db.delete_column('company_contract', 'is_billed')

        # Deleting field 'Contract.has_paid'
        db.delete_column('company_contract', 'has_paid')
