...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RoomRegistration.company'
        db.alter_column('logistics_roomregistration', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['company.Company'], null=True))


    def backwards(self, orm):
        
        # Changing field 'RoomRegistration.company'
        db.alter_column('logistics_roomregistration', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['company.Company']))
    ...
    models = {
        ...
        'logistics.roomregistration': {
            ...
            'date_saved': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'receipt': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
