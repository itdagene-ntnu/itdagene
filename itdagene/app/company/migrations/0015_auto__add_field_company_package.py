...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('company_company', 'package', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='companies', null=True, to=orm['company.Package']), keep_default=False)

        # Removing M2M table for field package on 'Company'
        db.delete_table('company_company_package')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field package on 'Company'
        db.create_table('company_company_package', (
        ...
        db.create_unique('company_company_package', ['company_id', 'package_id'])
