...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RoomRegistration'
        db.create_table('logistics_roomregistration', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='roomregistration_creator', to=orm['auth.User'])),
            ('saved_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='roomregistration_saved_by', to=orm['auth.User'])),
            ...
            ('room_nr', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('time_start', self.gf('django.db.models.fields.TimeField')()),
            ('time_end', self.gf('django.db.models.fields.TimeField')()),
        ))
        db.send_create_signal('logistics', ['RoomRegistration'])


    def backwards(self, orm):
        
        # Deleting model 'RoomRegistration'
        db.delete_table('logistics_roomregistration')
    ...
    models = {
        ...
        'logistics.roomregistration': {
            'Meta': {'object_name': 'RoomRegistration'},
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['company.Company']"}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'roomregistration_creator'", 'to': "orm['auth.User']"}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {}),
            'date_saved': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'room_nr': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'saved_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'roomregistration_saved_by'", 'to': "orm['auth.User']"}),
