        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=0, verbose_name='How did the kickstart go?', choices=[
                ...
                (
                    'course_rating',
                    models.IntegerField(
                        default=0, verbose_name='How did the course go?', choices=[
                            (0, 'Did not use'), (1, '1: Very bad'), (2, '2: Bad'),
                            (3, '3: Not bad or good'), (4, '4: Good'), (5, '5: Very good')
                        ]
                    )
                ...
                (
                    'course_improvement',
                    models.TextField(verbose_name='Could the course be handled better?')
                ),
                (
                    'visitors_rating',
                    models.IntegerField(
                ...
                (
                    ...
                    models.BooleanField(default=False, verbose_name='Did you use interview rooms?')
                ),
                (
                    'interview_location_rating',
                    models.IntegerField(
                        default=0, verbose_name='How was the interview room?', choices=[
                            (0, 'Did not use'), (1, '1: Very bad'), (2, '2: Bad'),
                            (3, '3: Not bad or good'), (4, '4: Good'), (5, '5: Very good')
                        ]
                    )
                ...
                (
                    ...
                    models.TextField(verbose_name='What could have been done better?', blank=True)
                ),
                (
                    'has_banquet',
                    models.BooleanField(default=False, verbose_name='Where you at the banquet?')
                ),
                (
                    'banquet_rating',
                    models.IntegerField(
                        default=0, verbose_name='How did the banquet go?', choices=[
                            (0, 'Did not use'), (1, '1: Very bad'), (2, '2: Bad'),
                            (3, '3: Not bad or good'), (4, '4: Good'), (5, '5: Very good')
                        ]
                    )
                ...
                (
                    'banquet_improvement',
                    models.TextField(
                        verbose_name='What could have been done better at the banquet?', blank=True
                    )
                ),
                (
                    'opening_hours',
                ...
                (
                    ...
                    models.TextField(
                        ...
                        verbose_name='Something else you want to comment?', blank=True
                    )
                ),
                (
                    'want_to_come_back',
                    models.BooleanField(
                        default=False, verbose_name='Interested in being contacted next year?'
                    )
                ),
            ],
            options={},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'status',
                    models.PositiveIntegerField(
                        default=0, verbose_name='status', choices=[
                            (0, 'New'), (1, 'In progress'), (2, 'Needs feedback'), (3, 'Finished')
                        ]
                    )
                ),
                ...
                (
                    'solved_date',
                    models.DateTimeField(null=True, verbose_name='solved date', blank=True)
                ),
                (
                    'assigned_user',
                    models.ForeignKey(
