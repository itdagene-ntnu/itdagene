...
class DigitalStand(BaseModel):
    ...
    livestream = models.URLField(blank=True, verbose_name=_("Livestream link"))
    qa = models.URLField(blank=True, verbose_name=_("Q&A link"))
    chat = models.URLField(blank=True, verbose_name=_("Chat link"))
