...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Preference.view_sp'
        db.add_column('core_preference', 'view_sp', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Preference.view_sp'
        db.delete_column('core_preference', 'view_sp')
