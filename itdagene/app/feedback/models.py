...
APPS = (('all', _('All')), ('admin', _('Admin')), ('company', _('BDB')),
        ('career', _('Career')), ('core', _('Core')), ('events', _('Events')),
        ('feedback', _('Feedback')), ('frontpage', _('Frontpage')),
        ('logistics', _('Logistics')), ('mail', _('Mail')),
        ('meetings', _('Meetings')), ('news', _('News')),
        ('notifications', _('Notifications')), ('pages', _('Pages')),
        ('profiles', _('Profiles')), ('todo', _('Todo')),
        ('venue', _('Venue')), ('workschedule', _('Workschedule')), )

TYPES = ((0, _('Bug')), (1, _('Feature')), (2, _('Cache problem')), )

STATUS = ((0, _('New')), (1, _('In progress')), (2, _('Needs feedback')),
          (3, _('Finished')), )
...
class Issue(BaseModel):
    ...
    solved_date = models.DateTimeField(blank=True,
                                       null=True,
    ...
    def get_absolute_url(self):
        return reverse('itdagene.app.feedback.views.issues.view',
                       args=[self.pk])
...
RATINGS = ((0, _('Did not use')), (1, _('1: Very bad')), (2, _('2: Bad')),
           (3, _('3: Not bad or good')), (4, _('4: Good')),
           (5, _('5: Very good')))
