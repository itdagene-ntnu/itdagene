...
from itdagene.app.todo.views import add_todo, change_todo, delete_todo, change_status, view_todo
...
urlpatterns = [
    ...
    url(r'^(?P<pk>\d+)/change/status/$', change_status, name='itdagene.app.todo.views.change_status'),
