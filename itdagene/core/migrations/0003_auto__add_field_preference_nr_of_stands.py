...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Preference.nr_of_stands'
        db.add_column('core_preference', 'nr_of_stands', self.gf('django.db.models.fields.PositiveIntegerField')(default=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Preference.nr_of_stands'
        db.delete_column('core_preference', 'nr_of_stands')
