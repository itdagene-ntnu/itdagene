    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        verbose_name=
                        "What could have been done better at the banquet?",
                        blank=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "company",
                    models.ForeignKey(to="company.Company",
                                      on_delete=models.CASCADE),
                ),
                (
                    "preference",
                    models.ForeignKey(to="core.Preference",
                                      on_delete=models.CASCADE),
                ),
            ],
            options={},
        ...
        migrations.AlterUniqueTogether(name="evaluationhash",
                                       unique_together=set([("preference",
                                                             "company")])),
        migrations.AddField(
