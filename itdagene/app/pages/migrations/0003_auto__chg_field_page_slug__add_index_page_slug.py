...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('pages_page', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Page.slug'
        db.alter_column('pages_page', 'slug', self.gf('django.db.models.fields.CharField')(max_length=100))
