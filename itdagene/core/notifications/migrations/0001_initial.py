...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notifications_notification', (
            ...
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 11, 15, 21, 56, 35, 62937))),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('send_mail', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('sent_mail', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
    ...
    models = {
        ...
        'notifications.notification': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 15, 21, 56, 35, 62937)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
