...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('company', '0017_auto_20160315_1953'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='company',
            name='logo',
            field=sorl.thumbnail.fields.ImageField(blank=True, null=True, upload_to='company_logos/', verbose_name='logo'),
        ),
        migrations.AlterField(
            model_name='company',
            name='payment_email',
            field=models.EmailField(blank=True, max_length=254, verbose_name='payment email'),
        ),
        migrations.AlterField(
