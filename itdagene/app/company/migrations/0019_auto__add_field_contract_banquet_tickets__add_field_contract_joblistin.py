...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contract.banquet_tickets'
        db.add_column('company_contract', 'banquet_tickets', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'Contract.joblistings'
        db.add_column('company_contract', 'joblistings', self.gf('django.db.models.fields.PositiveIntegerField')(default=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contract.banquet_tickets'
        db.delete_column('company_contract', 'banquet_tickets')

        # Deleting field 'Contract.joblistings'
        db.delete_column('company_contract', 'joblistings')
