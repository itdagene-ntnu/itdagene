...
class UserCreateForm(UserCreationForm):
    class Meta:
        model = User
        fields = ('username', 'password1', 'password2', 'first_name', 'last_name', 'email', 'mail_prefix', 'phone', 'language', 'mail_notification', 'photo', 'year', 'is_superuser', 'is_staff', 'groups', 'user_permissions')
...
class UserEditForm(forms.ModelForm):
    class Meta:
        model = User
        fields = ('first_name', 'last_name', 'email', 'mail_prefix', 'phone', 'language', 'mail_notification', 'photo', 'year', 'is_superuser', 'is_staff', 'groups', 'user_permissions')
