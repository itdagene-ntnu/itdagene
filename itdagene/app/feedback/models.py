...
RATINGS = (
    (0, _('Did not use')), (1, _('1: Very bad')), (2, _('2: Bad')), (3, _('3: Not bad or good')),
    (4, _('4: Good')), (5, _('5: Very good'))
)
...
class Evaluation(models.Model):
    ...
    communication_rating = models.IntegerField(
        choices=RATINGS, blank=False, verbose_name=_(
    ...
    internship_marathon_rating = models.IntegerField(
        choices=RATINGS, verbose_name=_('How did the internship marathon go?'), default=0
    )
    internship_marathon_improvement = models.TextField(
        blank=True, verbose_name=_('What could have been done better at the internship marathon?')
    )
    ...
    interview_location_improvement = models.TextField(
        blank=True, verbose_name=_('What could have been done better at the interview room?')
    )
    has_banquet = models.BooleanField(verbose_name=_('Were you at the banquet?'), default=False)
