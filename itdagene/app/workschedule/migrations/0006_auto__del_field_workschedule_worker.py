...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WorkSchedule.worker'
        db.delete_column('workschedule_workschedule', 'worker_id')
    ...
    def backwards(self, orm):
        # Adding field 'WorkSchedule.worker'
        db.add_column('workschedule_workschedule', 'worker',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='schedules', null=True, to=orm['workschedule.Worker'], blank=True),
                      keep_default=False)
