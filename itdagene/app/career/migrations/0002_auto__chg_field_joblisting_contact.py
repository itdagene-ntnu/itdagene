...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Joblisting.contact'
        db.alter_column('career_joblisting', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['company.CompanyContact'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Joblisting.contact'
        raise RuntimeError("Cannot reverse this migration. 'Joblisting.contact' and its values cannot be restored.")
    ...
    models = {
        ...
        'career.joblisting': {
            ...
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['company.CompanyContact']", 'null': 'True', 'blank': 'True'}),
            ...
            'towns': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['career.Town']", 'null': 'True', 'blank': 'True'}),
