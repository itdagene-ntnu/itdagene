...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('feedback_issue', 'type', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'Issue.status'
        db.add_column('feedback_issue', 'status', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Issue.type'
        db.delete_column('feedback_issue', 'type')

        # Deleting field 'Issue.status'
        db.delete_column('feedback_issue', 'status')
