...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkSchedule.worker'
        db.alter_column('workschedule_workschedule', 'worker_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workschedule.Worker'], null=True))

    def backwards(self, orm):

        # Changing field 'WorkSchedule.worker'
        db.alter_column('workschedule_workschedule', 'worker_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        'workschedule.workschedule': {
            ...
            'worker': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['workschedule.Worker']", 'null': 'True', 'blank': 'True'})
        }
    }
