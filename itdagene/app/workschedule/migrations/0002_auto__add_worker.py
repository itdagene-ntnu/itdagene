...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Worker'
        db.create_table('workschedule_worker', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='worker_creator', to=orm['auth.User'])),
            ('saved_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='worker_saved_by', to=orm['auth.User'])),
            ...
            ('t_shirt_size', self.gf('django.db.models.fields.IntegerField')()),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ))
        db.send_create_signal('workschedule', ['Worker'])


    def backwards(self, orm):
        # Deleting model 'Worker'
        db.delete_table('workschedule_worker')
