...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Joblisting.image'
        db.add_column('career_joblisting', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Joblisting.image'
        db.delete_column('career_joblisting', 'image')
    ...
    models = {
        ...
        'career.joblisting': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'joblistings'", 'to': "orm['company.Company']"}),
