...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Company.has_public_profile'
        db.add_column('company_company', 'has_public_profile', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Company.has_public_profile'
        db.delete_column('company_company', 'has_public_profile')
