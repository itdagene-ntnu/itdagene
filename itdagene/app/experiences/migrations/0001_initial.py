    ...
    operations = [migrations.CreateModel(
        ...
        fields=[('id', models.AutoField(verbose_name='ID',
                ...
                ('position', models.PositiveIntegerField(
                    ...
                    choices=[(0, b'Leder'), (1, b'Nestleder'), (2, b'Okonomi'),
                ...
                ('text', models.TextField(null=True,
                                          ...
                                          blank=True)),
                ('creator', models.ForeignKey(related_name=b'experience_creator',
                                              editable=False,
                                              to=settings.AUTH_USER_MODEL)),
                ('saved_by', models.ForeignKey(related_name=b'experience_saved_by',
                                               editable=False,
                                               to=settings.AUTH_USER_MODEL)),
                ('year', models.ForeignKey(verbose_name='Preference',
                                           to='core.Preference')), ],
