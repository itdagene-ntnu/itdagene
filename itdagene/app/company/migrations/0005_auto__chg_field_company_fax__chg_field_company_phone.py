...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('company_company', 'fax', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Company.phone'
        db.alter_column('company_company', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))


    def backwards(self, orm):
        
        # Changing field 'Company.fax'
        db.alter_column('company_company', 'fax', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Company.phone'
        db.alter_column('company_company', 'phone', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
