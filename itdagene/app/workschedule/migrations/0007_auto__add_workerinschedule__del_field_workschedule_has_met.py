...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WorkerInSchedule'
        db.create_table('workschedule_workerinschedule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='workerinschedule_creator', to=orm['auth.User'])),
            ('saved_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='workerinschedule_saved_by', to=orm['auth.User'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')()),
            ('date_saved', self.gf('django.db.models.fields.DateTimeField')()),
            ('schedule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workschedule.WorkSchedule'])),
            ('worker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workschedule.Worker'])),
            ('has_met', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('workschedule', ['WorkerInSchedule'])
    ...
    def backwards(self, orm):
        # Deleting model 'WorkerInSchedule'
        db.delete_table('workschedule_workerinschedule')
    ...
    models = {
        ...
        'workschedule.workerinschedule': {
            ...
            'schedule': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['workschedule.WorkSchedule']"}),
            'worker': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['workschedule.Worker']"})
        },
