...
urlpatterns = patterns(
    'itdagene.app.company.views', url(r'^companies/$', 'list_companies',
                                      name='companies'),
    url(r'^companies/(?P<id>\d+)/$', 'view',
        name='view_company'), url(r'^companies/add/$', 'add'),
...
urlpatterns += patterns(
    'itdagene.app.company.views.company_contacts',
    url(r'^contacts/(?P<company>\d+)/add/$', 'add_contact'),
    url(r'^contacts/(?P<id>\d+)/vcard$', 'vcard'),
    url(r'^contacts/(?P<contact_id>\d+)/edit/$', 'edit_contact',
        name='edit_company_contact'), url(
            r'^contacts/(?P<contact_id>\d+)/delete/', 'delete_contact',
            name='delete_company_contact'), )
urlpatterns += patterns(
    'itdagene.app.company.views.contracts',
...
urlpatterns += patterns(
    'itdagene.app.company.views.packages', url(r'^packages/$', 'list'),
    url(r'^packages/add$', 'add'), url(r'^packages/(?P<id>\d+)/$', 'view'),
