...
urlpatterns = [
    ...
    re_path(r'^task/(?P<id>\d+)/$', views.view_task, name='itdagene.workschedule.view_task'),
    re_path(r'^task/(?P<id>\d+)/edit$', views.edit_task, name='itdagene.workschedule.edit_task'),
    # re_path(r'^worker/(?P<id>\d+)/$', views.view_worker, name='itdagene.workschedule.view_worker')
    re_path(
        r'^worker/(?P<id>\d+)/edit$', views.edit_worker, name='itdagene.workschedule.edit_worker'
    ),
    re_path(
