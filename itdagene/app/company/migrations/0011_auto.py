...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('company_company_waiting_for_package', (
        ...
        db.create_unique('company_company_waiting_for_package', ['company_id', 'package_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field waiting_for_package on 'Company'
        db.delete_table('company_company_waiting_for_package')
