                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, verbose_name='status', choices=[
                            (0, 'Not contacted'), (4, 'Contacted'), (1, 'Not interested'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'phone',
                    models.CharField(
                        max_length=20, null=True, verbose_name='phone number', blank=True
                    )
                ),
                (
                    'mobile_phone',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'file',
                    models.FileField(
                        upload_to='contracts/', null=True, verbose_name='file', blank=True
                    )
                ),
                (
                    'banquet_tickets',
                    models.PositiveIntegerField(default=1, verbose_name='banquet tickets')
                ),
                ('joblistings', models.PositiveIntegerField(default=2, verbose_name='joblistings')),
                (
                    'interview_room',
                    models.PositiveIntegerField(default=0, verbose_name='interview room')
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'description',
                    models.TextField(
                        help_text='This field supports markdown', verbose_name='description'
                    )
                ),
